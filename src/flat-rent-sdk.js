...
//export const sendDatabase = database
      ...
      try {
        ...
        if (parameters.priceLimit != null) {
          flats = flats.filter((flat) => {
            //console.log(flat.price <= parameters.priceLimit)
        ...
        flats = flats.map((flat) => {
          ...
          return this._formatFlatObject(flat)
        })
